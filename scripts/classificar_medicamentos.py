...
"dermocosmetico"
  ...
  Exemplos: protetor solar (FPS/SPF), hidratante facial, sérum facial, tônico facial, esfoliante, creme anti-age,
           ...
           shampoo anticaspa terapêutico, máscara capilar tratamento, óleo capilar tratamento.
  NÃO inclui: acetona, esmalte, perfume, maquiagem de cor (= perfumaria); sabonete/shampoo comum (= higiene).
...
"perfumaria"
  ...
  Exemplos: perfume, colônia, água de toilette, desodorante spray/aerossol, esmalte para unhas, acetona,
           ...
           máscara de cílios (maquiagem), bronzeador/autobronzeador, glitter, sombra.
...
━━━ ATENÇÃO — distinções críticas ━━━
  ...
  - "PERFUMARIA"/"PERFUMARIA/COSMETICO" → perfumaria (esmalte, acetona, perfume) ou dermocosmetico (SPF, tratamento)
  ...
  - Pomada/creme com princípio ativo identificável → similar ou referencia (NÃO dermocosmetico)
