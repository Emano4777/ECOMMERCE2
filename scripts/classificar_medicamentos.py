...
"perfumaria"
  ...
  NÃO inclui: protetor solar (FPS/SPF), sérum facial, hidratante facial, creme anti-age, clareador → use dermocosmetico
...
━━━ ATENÇÃO — distinções críticas ━━━
  ...
  - "CORRELATOS" na classe → varejo (insumos hospitalares vão para varejo; correlato não existe mais)
